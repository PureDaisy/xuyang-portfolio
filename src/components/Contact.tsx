    ...
    <section id="contact" className="py-24 bg-slate-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700/50">
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-slate-600 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium">@PureDaisy</p>
                  </div>
                </a>
          ...
          {/* Message / CTA */}
          <div className="space-y-6">
            <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700/50 h-full flex flex-col">
              <h3 className="text-lg font-semibold text-white mb-4">求职意向</h3>
              <div className="flex-1">
                <p className="text-slate-400 mb-4">
                  正在寻找以下方向的实习/全职机会：
                </p>
                <div className="space-y-3">
                  {['AI Agent 开发工程师', '全栈工程师', '移动端开发工程师'].map((role) => (
